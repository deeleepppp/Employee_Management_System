  ...
  return (
    <div className='h-auto flex-shrink-0 p-4 sm:p-5 w-full sm:w-[300px] bg-red-400 rounded-xl'>
      ...
      <div className='mt-4 flex flex-col sm:flex-row justify-between gap-2'>
        <button className='rounded bg-blue-500 py-1 px-2 text-xs sm:text-sm'>Mark as Completed</button>
        <button className='rounded bg-red-500 py-1 px-2 text-xs sm:text-sm'>Mark as Failed</button>
      </div>
    </div>
  );
}
